...
async function haeLinjat() {  //Haetaan apista tiedot linjoista.
  try{
    const vastaus = await fetch('https://opendata.arcgis.com/datasets/015369a569e340cd953222dd441f4bb6_0.geojson', {method: 'GET'}); //Haetaan lämpötilat apista.
...
function linjatKartalle(linjat) {  //Sijoitetaan apista kerätyt tiedot kartalle.
